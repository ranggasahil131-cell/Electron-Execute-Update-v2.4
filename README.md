...
[![Stars](https://img.shields.io/github/stars/Electron-Execute-Update-v2.4?style=flat-square)](https://github.com)
...
git clone https://github.com/Electron-Execute-Update-v2.4.git
cd Electron-Execute-Update-v2.4
